...
class MembersActivity : BaseActivity() {
    ...
    fun memberAssignSuccess(user: User) {
        ...
        // (Step 5: Call the AsyncTask class when the board is assigned to the user and based on the users detail send them the notification using the FCM token.)
        // START
        SendNotificationToUserAsyncTask(mBoardDetails.name, user.fcmToken).execute()
        // END
    }

    //  (Step 2: Create a AsyncTask class for sending the notification to user based on the FCM Token.)
    // START
    /**
    ...
    private inner class SendNotificationToUserAsyncTask(val boardName: String, val token: String) :
        ...
        override fun doInBackground(vararg params: Any): String {
            ...
            try {
                ...
                //  (Step 3: Add the firebase Server Key.)
                // START
                ...
                //  (Step 4: Create a notification data payload.)
                // START
