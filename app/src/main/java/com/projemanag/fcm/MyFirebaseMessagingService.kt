...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        //  (Step 7: Once the notification is sent successfully it will be received here.)
        // START
    ...
    //  (Step 6: Change the notification definition as add the parameters for title and message.)
    /**
    ...
    private fun sendNotification(title: String, message: String) {
        ...
        //  (Step 9: Now once the notification is received and visible in the notification tray than we can navigate them into the app as per requirement.)
        // START
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            ...
            //  (Step 8: Set the title and message for the notification which will be visible in the notification tray.)
            // START
